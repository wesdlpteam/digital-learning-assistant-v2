...
const OPENAI_MODEL = 'gpt-5.6-terra';       // main model (Bulk AI Edit, Fix All, regenerate, scoring)
const OPENAI_FAST_MODEL = 'gpt-5.6-terra';  // feedback & single-suggestion regen — balanced intelligence and cost
